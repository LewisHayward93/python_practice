...
# pop from list #
last_motorcyle = motorcycles.pop(1) # can specify which element to pop, empty () is the last one
print(motorcycles)
print(last_motorcyle) # now string and not part of a list

# remove item by value not index #
motorcycles.remove("suzuki") # can also pass in a variable here, deletes first occurence
print(motorcycles)
...
print(motorcycles) 
print(sorted(motorcycles)) # temporarily sorts the list but won't change the original list permanently
